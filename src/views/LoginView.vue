<template>
    <div class="template__outside template__outside__registrati" v-if="this.sezione__accesso == 0">
        <div class="template__inside">
            ...
            <a>Hai un account artella?</a> <a style="color: #FF5400; cursor: pointer;"
                    @click="this.sezione__accesso = 1">Accedi</a>
        </div>
        <div class="template__inside">
    ...
    <div class="template__outside template__outside__accedi" v-if="this.sezione__accesso != 0">
        <div class="template__inside">
            ...
            <a>
                Non hai un account artella?</a> <a style="color: #FF5400; cursor: pointer;"
                    @click="this.sezione__accesso = 0">Registrati</a>
        </div>
        <div class="template__inside">
